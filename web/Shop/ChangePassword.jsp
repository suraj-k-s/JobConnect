...
<html>
    ...
    <%
        ...
        if (request.getParameter("btn_save") != null) {
            ...
            String selQry = "select * from tbl_shop where Shop_id='" + id + "'";
            ResultSet rs = con.selectCommand(selQry);
            if (rs.next()) {

                db_password = rs.getString("Shop_password");
            }
            if (current_password.equals(db_password)) {
                if (newpass.equals(Repass)) {
                    String updQry = "update tbl_shop SET Shop_password='" + newpass + "' where Shop_id='" + session.getAttribute("sid") + "'";
