...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                String InsQry = "INSERT INTO tbl_user(place_id,user_name,user_contact, user_email,user_password,user_address,user_photo, user_proof,user_description)"
                            + "values('" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + photo  + "','" + proof+ "','" + value[7] + "')";
