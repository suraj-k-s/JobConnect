...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                String InsQry = "INSERT INTO tbl_shop(place_id,shop_name,shop_contact,shop_address,shop_email,shop_password,shop_photo, shop_proof)"
                            + "values('" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + photo  + "','" + proof+ "')";
